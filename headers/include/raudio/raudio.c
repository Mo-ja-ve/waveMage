...
*
**********************************************************************************************/
#define RAUDIO_STANDALONE TRUE
#define SUPPORT_MODULE_RAUDIO TRUE
#define SUPPORT_FILEFORMAT_MP3 TRUE
...
void UpdateMusicStream(Music music)
{
    ...
    //printf("\nsubBufferSizeInFrames: %d", subBufferSizeInFrames);
    //printf("\nPCM SIZE: %d", pcmSize);
    //printf("\nframeSize: %d", frameSize);
    //printf("\nmusic.stream.sampleSize: %d", music.stream.sampleSize);
